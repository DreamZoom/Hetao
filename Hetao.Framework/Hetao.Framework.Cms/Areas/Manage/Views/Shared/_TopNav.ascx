                ...
                <ul class="nav pull-right">
                    ...
                    <li class="dropdown user">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            ...
                            <span class="username"><%: Hetao.Framework.Web.Auth.AuthorProvider.Admin.getName() %></span>
                            <i class="icon-angle-down"></i>
                        </a>
                        <ul class="dropdown-menu">
                            
                            <li><a href="<%:Url.Action("ChangePassword","Main") %>"><i class="icon-tasks"></i>修改密码</a></li>
                           
                            <li><a href="<%:Url.Action("LogOut","Main") %>"><i class="icon-key"></i>退出</a></li>
                        </ul>
                    </li>
